<template>
  <aside class="[grid-area:aside] flex flex-col justify-start">
    <div class="flex items-center justify-center gap-2 font-extrabold text-2xl mt-4 text-gray-700">
    ...
    <nav class="pl-5 py-3" aria-label="Navegación principal">
      <ul class="flex flex-col justify-center gap-1">
        ...
        <NavButton :key="menu.label" v-for="menu in menus" :label="menu.label" :icon="menu.icon" :submenus="menu.submenus">
          {{ menu.label }}
        </NavButton>
      </ul>
    </nav>
