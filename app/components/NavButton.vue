<template>
  <li class="relative flex items-center justify-start gap-2 group">
    ...
    >
      ...
      <slot />
      <Icon name="material-symbols:arrow-back-2-rounded" :class="`ml-auto transition-transform duration-300 ${activeMenu === 'menu ' + label ? 'rotate-180' : 'rotate-[270deg] group-hover:rotate-180'}`" />
    </button>
